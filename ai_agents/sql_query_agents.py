...
if __name__ == "__main__":
    ...
    user_input = "What is the city that had the highest number of COVID-19 case at the height of the pandemic in the US?"

    with trace("SQL Query Agents"):
    
        asyncio.run(run_sql_query_agents(user_input,snowflake_db,force_validator_agent))