...
async def run_chart_generator_agents(user_input: str, df_info: str) -> ChartAgentFinalOutput:
    ...
    if not chart_result.final_output.visualization_needed:
        print("Chart not needed:\n", chart_result.final_output.comment)
...
if __name__ == "__main__":
    ...
    dct = {'ID': {0: 23, 1: 43, 2: 12, 3: 13, 
                4: 67, 5: 89, 6: 90, 7: 56, 
                8: 34}, 
        'Name': {0: 'Bob', 1: 'Adrie', 2: 'Julien',
                    3: 'Alex', 4: 'Matt', 5: 'Wess',
                    6: 'John', 7: 'Louis',
                    8: 'Philippine' }, 
